            ...
            for (int x = 0; x < xTile; x++) {
                ...
                if (BASIC_CHARACTERS.contains(char0)) { //quick codes
                    ...
                    switch (char1) {
                        ...
                        case '0' -> checkPoints[0] = new Point.SpawnPoint(x+1, y+1, char2 == 'B');
                        case '1', '2', '3', '4' -> checkPoints[char1-'0'] = new Point.CheckPoint(x+1, y+1, char1-'0', char2 == 'B');
                        case '5', '6', '7', '8', '9' -> winPoints.add(new Point.WinPoint(x+1, y+1, char1-'5', char2 == 'B'));
                        ...
                        case 'D' -> {
                            ...
                            doors.add(new Door(alignment, x + 1, y + 1));
                        }
...
//careful! the button coordinates entered in txt file has starting index 1, while mapData has 0!
            ...
            switch (items[1].charAt(0)) {
                case '|' -> doors.add(new Door(Alignment.V, x+1, y+1, l, buttonsToWire.toArray(new Button[0])));
                case '—' -> doors.add(new Door(Alignment.H, x+1, y+1, l, buttonsToWire.toArray(new Button[0])));
